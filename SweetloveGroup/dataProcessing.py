...
######################################################################
# This function reads fluxes from CSV file generated by writeSolution#
# -Fluxes and updates the x_dict of solution object                  #
# input aurguments: a solution object, full path of file             #
# output aurguments: a solution object with updated x_dict           #
######################################################################
def readSolutionFluxesFromFile(sol,infile):
    import pandas as pd
    df= pd.read_csv(infile,index_col=0)
    for r in sol.x_dict.keys():
        sol.x_dict[r]=df["fluxes"][r]
    return sol
